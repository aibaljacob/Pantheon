...
export const AddEditRoleModal: React.FC<AddEditRoleModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn">
      <div className="relative w-full max-w-2xl max-h-[90vh] flex flex-col rounded-3xl border border-[#363433] bg-[#141312] shadow-2xl text-[#e6e2df] overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-[#2b2a29] px-6 py-5 shrink-0 bg-[#141312]">
        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col min-h-0 overflow-hidden">
          ...
          <div className="flex items-center justify-end gap-3 border-t border-[#2b2a29] px-6 py-4 shrink-0 bg-[#141312]">
            <button
              type="button"
              onClick={onClose}
            ...
            >
              {isSubmitting ? (
                ...
                <>
                  ...
                  <span>{roleToEdit && roleToEdit.id ? 'Update Role' : 'Publish Role'}</span>
                </>
              )}
            </button>
          </div>
