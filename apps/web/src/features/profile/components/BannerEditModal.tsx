...
import { X, Upload, Trash2, Loader2, AlertCircle, Image as ImageIcon, Crop } from 'lucide-react';
...
export const BannerEditModal: React.FC<BannerEditModalProps> = ({
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Reset input target value so user can select the same file again if they want
    e.target.value = '';
  };
  ...
  return (
    <>
      ...
      {/* Interactive Crop / Section Chooser Modal */}
      {rawCropImageSrc && (
        <ImageCropModal
          isOpen={isCropOpen}
